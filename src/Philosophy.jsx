...
const Philosophy = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Philosophy – Dot & Cross</title>
        <meta
          name="description"
          content="We brand for alignment, not attention. Discover the principles that shape our approach to branding and strategy."
        />
        <link rel="canonical" href="https://dotandcross.agency/philosophy" />
      </Helmet>

      <div className="fixed inset-0 bg-[#F8F8F8] text-[#1e1e1e] z-40 flex flex-col justify-between px-4 pt-[120px] overflow-y-auto">
        <div className="absolute top-0 left-0 w-full h-20 sm:h-24 bg-[#1e1e1e] z-[-1]"></div>
        ...
        <div
          onClick={() => navigate("/")}
          className="inline-block overflow-visible mt-10 mb-8 px-1 z-50"
        >
